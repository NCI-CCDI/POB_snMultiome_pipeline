...
option_parser <- add_option(option_parser, "--nCount_ATAC_UL", type = "integer", default = 0,
                            help = "Lower Limit for nCount_ATAC for minimal ATAC filtering")
...
df_filter = data.frame("Sample" = character(), "nCount_RNA_LL"=numeric(), "nCount_RNA_UL"=numeric(),"nFeature_RNA"=numeric(),"percent_mt"=numeric(),
