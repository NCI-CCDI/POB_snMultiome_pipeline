...
reticulate::source_python(paste0(working_dir,'/scripts/R/utility/scrublet_py_YW.py'))
...
#source("/data/CCRCCDI/software/Scripts/current_snakemake/snMultiome_split_v2/scripts/R/utility/doublet_finder.r")
...
doublet_rate_adj = unique(object@meta.data$doublet_rate_adj)

object <- object %>% 
  scrublet_YW(n_prin_comps=30, expected_doublet_rate=doublet_rate,doublet_rate_adj=doublet_rate_adj, sample=sample,path=sample_result_path,umi_min =nCount_RNA_LL,ngene_min=nFeature_RNA_LL,mt_max=mt_UL) 
