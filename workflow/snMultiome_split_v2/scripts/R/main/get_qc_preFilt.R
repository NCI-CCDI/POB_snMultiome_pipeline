...
#working_dir = "/data/CCRCCDI/analysis/ccrccdi4/Analyis_filtGEXATAC"
...
object.list <- readRDS(paste0(output_path,"/seurat/2.object_list_rawGEXATAC.rds"))
...
df_all
write.table(df_all, file = paste(plot_path,"/QC_stats_preFilt.tsv",sep=""), quote=FALSE,sep="\t", row.names=FALSE)
